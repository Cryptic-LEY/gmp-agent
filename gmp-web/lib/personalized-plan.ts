...
export interface PersonalizedSchemeOptions {
  summary?: string
  aiFocus?: string[]
}
...
export function buildPersonalizedScheme(plan: PlanItem[], score: number, options: PersonalizedSchemeOptions = {}): PersonalizedScheme {
  ...
  const summary = options.summary ?? (score < 60
