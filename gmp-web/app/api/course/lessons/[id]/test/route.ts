...
import { calculateLessonScore, getLessonBaseScore, gradeLessonTest, safeJsonArray, type LessonQuestion } from '@/lib/course-learning'
...
export async function POST(req: NextRequest, { params }: { params: Promise<{ id: string }> }) {
  ...
  const lessonScore = calculateLessonScore({
  ...
  }, getLessonBaseScore(scopedLessons.length))
