...
const FAQ_SECTIONS = [
  ...
  },
  {
    ...
    faqs: [
      ...
      {
        q: '积分（XP）是如何获得的？',
        a: 'XP 的主要来源：① 每日首次登录打卡 +5 XP；② 连续打卡里程碑奖励（第 3 天 +50 XP、第 7 天 +150 XP、第 14 天 +300 XP、第 30 天 +600 XP）；③ 答对练习题 +10~25 XP（根据题型）。',
      },
      {
        q: '实训游戏中的金币和钻石如何获得？',
        a: '进入「实训仿真」后的地图主页，点击「补给」即可每天领取 +160 金币和 +8 钻石。完成当前关卡可获得 +360 金币、+18 钻石和 1 枚奖杯；若挑战未通过，也会获得 +80 金币作为复盘补给，再前往商店兑换道具继续挑战。',
      },
      {
        q: '等级系统是怎样的？',
  ...
  },
  {
    ...
    faqs: [
      ...
      {
        q: 'AI 的回答准确吗？',
        a: 'AI 回答基于 2010 版《药品生产质量管理规范》及相关附录，引用条款均有出处。但 AI 并非执法机构，关键决策请以官方法规文本为准，建议将 AI 助学作为学习辅助而非唯一依据。',
      },
    ],
  },
  {
...
const GAME_RULES = [
  ...
  { icon: '🤝', title: '行为规范', desc: '本平台仅用于 GMP 学习，禁止用于商业目的或传播未经核实的监管信息。AI 助学内容仅供学习参考，正式执行请以官方文件为准。' },
]
