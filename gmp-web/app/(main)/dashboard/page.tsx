...
export default function DashboardPage() {
  ...
  return (
    <div style={{
      ...
      {/* ── Hero ── */}
      <section style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(320px, 1fr))', gap: 16, marginBottom: 14 }}>

        {/* Book cover */}
        <div style={{
          position: 'relative', display: 'grid',
          gridTemplateColumns: 'repeat(auto-fit, minmax(180px, 1fr))',
          gap: 14, alignItems: 'stretch', minHeight: 252, padding: 18, overflow: 'hidden',
          ...
          {/* White book panel */}
          <div style={{ position: 'relative', zIndex: 1, borderRadius: 10, display: 'grid', alignContent: 'center', minHeight: 204, padding: 18, overflow: 'hidden', background: 'linear-gradient(90deg, rgba(24,59,75,0.08) 1px, transparent 1px), linear-gradient(180deg, rgba(24,59,75,0.08) 1px, transparent 1px), rgba(255,255,255,0.82)', backgroundSize: '18px 18px, 18px 18px, auto', border: '1px solid rgba(75,67,156,0.2)', boxShadow: 'inset 0 0 0 8px rgba(255,255,255,0.34)' }}>
            ...
            <div style={{ position: 'relative', display: 'grid', placeItems: 'center', justifySelf: 'center', width: 'min(100%, 244px)', height: 104, marginBottom: 10, borderTop: '11px solid rgba(75,67,156,0.82)', borderRadius: '50% 50% 0 0 / 80% 80% 0 0' }}>
          ...
          <div style={{ position: 'relative', zIndex: 1, borderRadius: 10, display: 'grid', alignContent: 'end', gap: 12, minHeight: 204, padding: 20, color: '#f5fbfd', background: 'linear-gradient(135deg, rgba(17,42,58,0.96), rgba(29,111,120,0.86)), #183b4b' }}>
        ...
        <div style={{ ...PANEL, display: 'flex', flexDirection: 'column', justifyContent: 'space-between', gap: 16, padding: 24 }}>
          ...
          <div style={{ display: 'flex', flexWrap: 'wrap', gap: 10 }}>
            <button onClick={() => router.push('/course')} style={{ display: 'flex', alignItems: 'center', gap: 6, padding: '9px 20px', background: '#1d6f78', color: '#fff', border: 'none', borderRadius: 6, fontSize: 14, fontWeight: 600, cursor: 'pointer' }}>
              <Play size={14} />去学习
            </button>
      ...
      {/* ── 学习与实训资产栏 ── */}
      <section style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(168px, 1fr))', gap: 10, marginBottom: 12 }}>
        {/* XP / 等级 */}
        <div style={{ ...PANEL, padding: '14px 18px', display: 'flex', alignItems: 'center', gap: 14 }}>
          ...
          <div style={{ flex: 1, minWidth: 0 }}>
            <div style={{ display: 'flex', alignItems: 'baseline', gap: 6 }}>
              <span style={{ fontSize: 22, fontWeight: 800, color: '#183b4b' }}>{gs?.xp ?? '—'}</span>
              <span style={{ fontSize: 12, color: '#6b7d86' }}>XP</span>
            </div>
            <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginTop: 4 }}>
              <span style={{ fontSize: 12, color: '#1d6f78', fontWeight: 600 }}>{gs?.rankTitle ?? '正在同步'}</span>
            ...
            <div style={{ marginTop: 6, height: 5, borderRadius: 999, background: 'rgba(29,111,120,0.12)', overflow: 'hidden' }}>
              <div style={{ height: '100%', width: `${(gs?.rankProgress ?? 0) * 100}%`, background: 'linear-gradient(90deg,#1d6f78,#35818a)', borderRadius: 999, transition: 'width 0.5s ease' }} />
            </div>
          </div>
        </div>
        ...
        {/* HP（与实训 Boss 战同步） */}
        <div style={{ ...PANEL, padding: '14px 18px', display: 'flex', alignItems: 'center', gap: 14 }}>
          <div style={{ width: 42, height: 42, borderRadius: 12, background: 'linear-gradient(135deg,#0f766e,#14b8a6)', display: 'flex', alignItems: 'center', justifyContent: 'center', flexShrink: 0 }}>
            <HeartPulse size={20} color="#fff" />
          </div>
          <div style={{ flex: 1, minWidth: 0 }}>
            <div style={{ display: 'flex', alignItems: 'baseline', gap: 6 }}>
              <span style={{ fontSize: 22, fontWeight: 800, color: '#183b4b' }}>{assetsReady ? assets.hp : '—'}</span>
              <span style={{ fontSize: 12, color: '#6b7d86' }}>HP</span>
            </div>
            <div style={{ marginTop: 2, fontSize: 12, color: '#0f766e', fontWeight: 600 }}>实训健康值</div>
            <div style={{ marginTop: 6, height: 5, borderRadius: 999, background: 'rgba(15,118,110,0.12)', overflow: 'hidden' }}>
              <div style={{ width: `${assets.hp}%`, height: '100%', borderRadius: 999, background: 'linear-gradient(90deg,#14b8a6,#5eead4)' }} />
            </div>
          </div>
        </div>
        ...
        <div style={{ ...PANEL, padding: '14px 18px', display: 'flex', alignItems: 'center', gap: 14 }}>
          ...
          <div style={{ flex: 1, minWidth: 0 }}>
            <div style={{ display: 'flex', alignItems: 'baseline', gap: 6 }}>
              <span style={{ fontSize: 22, fontWeight: 800, color: '#183b4b' }}>{assetsReady ? assets.coins.toLocaleString() : '—'}</span>
              <span style={{ fontSize: 12, color: '#6b7d86' }}>金币</span>
            </div>
            <div style={{ marginTop: 2 }}>
              <span style={{ fontSize: 12, color: '#d97706', fontWeight: 600 }}>实训货币</span>
            </div>
            <div style={{ marginTop: 4, fontSize: 11, color: '#9ba8b0' }}>补给领取 / 关卡奖励</div>
          </div>
        </div>

        {/* 钻石（与实训钱包同步） */}
        <div style={{ ...PANEL, padding: '14px 16px', display: 'flex', alignItems: 'center', gap: 12 }}>
          <div style={{ width: 42, height: 42, borderRadius: 12, background: 'linear-gradient(135deg,#0891b2,#38bdf8)', display: 'flex', alignItems: 'center', justifyContent: 'center', flexShrink: 0 }}>
            <Gem size={20} color="#fff" />
          </div>
          <div style={{ flex: 1, minWidth: 0 }}>
            <div style={{ display: 'flex', alignItems: 'baseline', gap: 6 }}>
              <span style={{ fontSize: 22, fontWeight: 800, color: '#183b4b' }}>{assetsReady ? assets.gems.toLocaleString() : '—'}</span>
              <span style={{ fontSize: 12, color: '#6b7d86' }}>钻石</span>
            </div>
            <div style={{ marginTop: 2, fontSize: 12, color: '#0891b2', fontWeight: 600 }}>稀有补给</div>
            <div style={{ marginTop: 4, fontSize: 11, color: '#9ba8b0' }}>每日与通关可获得</div>
          </div>
        </div>

        {/* 奖杯（与实训通关同步） */}
        <div style={{ ...PANEL, padding: '14px 16px', display: 'flex', alignItems: 'center', gap: 12 }}>
          <div style={{ width: 42, height: 42, borderRadius: 12, background: 'linear-gradient(135deg,#b87808,#facc15)', display: 'flex', alignItems: 'center', justifyContent: 'center', flexShrink: 0 }}>
            <Trophy size={20} color="#fff" />
          </div>
          <div style={{ flex: 1, minWidth: 0 }}>
            <div style={{ display: 'flex', alignItems: 'baseline', gap: 6 }}>
              <span style={{ fontSize: 22, fontWeight: 800, color: '#183b4b' }}>{assetsReady ? assets.trophies.toLocaleString() : '—'}</span>
              <span style={{ fontSize: 12, color: '#6b7d86' }}>奖杯</span>
            </div>
            <div style={{ marginTop: 2, fontSize: 12, color: '#b87808', fontWeight: 600 }}>通关荣誉</div>
            <div style={{ marginTop: 4, fontSize: 11, color: '#9ba8b0' }}>完成远征关卡获取</div>
          </div>
        </div>
        ...
        <div style={{ ...PANEL, padding: '14px 16px', display: 'flex', alignItems: 'center', gap: 12 }}>
          ...
          <div style={{ flex: 1, minWidth: 0 }}>
            <div style={{ display: 'flex', alignItems: 'baseline', gap: 6 }}>
              <span style={{ fontSize: 22, fontWeight: 800, color: '#183b4b' }}>{assetsReady ? assets.creditHours : '—'}</span>
              <span style={{ fontSize: 12, color: '#6b7d86' }}>课时分</span>
            </div>
            <div style={{ marginTop: 2 }}>
              <span style={{ fontSize: 12, color: '#7c3aed', fontWeight: 600 }}>学业成绩</span>
            </div>
            <div style={{ marginTop: 4, fontSize: 11, color: '#9ba8b0' }}>游戏项目累计 / 350</div>
          </div>
        </div>
      </section>

      {/* ── Metric strip ── */}
      <section style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(132px, 1fr))', gap: 10, marginBottom: 12 }}>
        {[
      ...
      {/* ── Tab bar ── */}
      <div style={{ background: 'rgba(255,255,255,0.76)', border: '1px solid rgba(30,77,88,0.1)', borderRadius: 12, padding: '6px 10px 0', marginBottom: 12, display: 'flex', gap: 6, overflowX: 'auto', boxShadow: '0 14px 28px rgba(29,53,74,0.06)' }}>
        {TABS.map(({ id, label, icon: Icon }) => (
          <button key={id} onClick={() => handleTabClick(id)} style={{ display: 'inline-flex', alignItems: 'center', gap: 8, height: 46, padding: '0 16px', border: 'none', borderBottom: activeTab === id ? '3px solid #1d6f78' : '3px solid transparent', background: activeTab === id ? 'rgba(29,111,120,0.11)' : 'transparent', color: activeTab === id ? '#1d6f78' : '#183b4b', fontSize: 15, fontWeight: 800, cursor: 'pointer', transition: 'color 0.2s, background-color 0.2s', borderRadius: '10px 10px 0 0', whiteSpace: 'nowrap', flexShrink: 0 }}>
